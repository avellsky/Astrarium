...
- **時刻を自由に動かす** — 任意の日時へジャンプ、最大 ×6000 の連続再生、朔望月送り
- **惑星の拡大表示** — 視直径・輝面比・距離・軌道要素と、木星／土星／火星の衛星の配置
...
- **イベント一覧** — 日食・月食（局地予報つき）、衝・合、二至二分、恒星食、月と惑星の接近
- **4 種の経緯線**、天の赤道・黄道・銀河面・子午線、写野角枠（Seestar・DWARF・カメラレンズ）
- **ナイトモード**（赤色画面）、**PNG／PDF 出力**（白背景の印刷用配色）、字幕つきデモ再生

## 収録データ（すべて内蔵・オフラインで動作）

| 内容 | 出典 |
|---|---|
| 恒星 9,096 個（約 8 等まで） | Yale Bright Star Catalogue (BSC5) |
...
画面の見かた、操作、流星群の出現数の計算、人工衛星、PNG／PDF 出力まで、実機の画面を添えて説明しています。Mac 版は右パネルの構成とマウス・トラックパッドの操作に合わせた別冊です。
...
- **Drive the clock** — jump to any date, run time at up to ×6000, step by the synodic month
- **Planet close-ups** — apparent diameter, phase, distances, orbital elements, and the moons of Jupiter, Saturn and Mars
...
- **Events** — eclipses with local circumstances, oppositions and conjunctions, solstices and equinoxes, occultations
- **Four coordinate grids**, the celestial equator, ecliptic, galactic plane and meridian, and field-of-view frames
- **Night-vision mode**, **PNG/PDF export** on white paper, and a captioned demo tour

## Catalogues (all bundled — it works offline)

| Contents | Source |
|---|---|
| 9,096 stars, to about magnitude 8 | Yale Bright Star Catalogue (BSC5) |
